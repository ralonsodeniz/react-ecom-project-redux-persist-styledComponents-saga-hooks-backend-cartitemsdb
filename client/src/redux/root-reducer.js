...
// we create a filter to just select cartItems from cart reducer for persisting purposes
const cartItemsFilter = createFilter("cart", ["cartItems"]);
